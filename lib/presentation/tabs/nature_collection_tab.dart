...
class _NatureCollectionTabState extends State<NatureCollectionTab> {
  ...
  //when user reach to end of list the next page will call using loadNextPage() function
  ...
  //when user push down the list it will call previous page using loadPreviousPage() function
